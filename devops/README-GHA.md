...
2. Go to your repository at [collective/projektarbeit](https://github.com/collective/projektarbeit).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `projektarbeit.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | projektarbeit.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | projektarbeit.example.com |
...
- [Backend Tests Workflow](https://github.com/collective/projektarbeit/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/collective/projektarbeit/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/collective/projektarbeit-backend`) and Frontend (`ghcr.io/collective/projektarbeit-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of projektarbeit.example.com](https://github.com/collective/projektarbeit/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/projektarbeit.example.com.yml` stack.

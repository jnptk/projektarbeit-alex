...
from projektarbeit.interfaces import IProjektarbeit
from ZTUtils import make_query
from plone.dexterity.interfaces import IDexterityContent
from plone.app.discussion.interfaces import IComment
from projektarbeit import config
from projektarbeit.compat import to_str
...
@interface.implementer(IProjektarbeit)
class Tags(Service):

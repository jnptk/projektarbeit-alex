...
```
DEPLOY_ENV=prod
DEPLOY_HOST=projektarbeit.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    projektarbeit.example.com:
      ansible_user: root
      host: projektarbeit
      hostname: projektarbeit.example.com
```
...
Deploy the stack defined in `devops/stacks/projektarbeit.example.com.yml` to the remote server with:
